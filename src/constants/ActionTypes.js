// Customizer const
export const COLLABSABLE_NAV_ITEM_CLICKED = 'collapsable_nav_item_clicked';
...
export const ON_PATIENT_SELECT = 'on_patient_select';
export const ON_ADD_PATIENT = 'on_add_patient';
export const ON_PATIENT_CLOSE = 'on_patient_close';
export const ON_SAVE_PATIENT = 'on_save_patient';
export const ON_DELETE_PATIENT = 'on_delete_patient';
export const ON_DELETE_SELECTED_PATIENT = 'on_delete_selected_patient';
export const FILTER_PATIENT = 'filter_patient';
export const GET_ALL_PATIENT = 'get_all_patient';
export const GET_UNSELECTED_ALL_PATIENT = 'get_unselected_all_patient';
export const ON_ALL_PATIENT_SELECT = 'on_all_patient_select';
export const HIDE_PATIENT_LOADER = 'hide_patient_loader';
