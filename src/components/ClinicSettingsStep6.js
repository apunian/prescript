...
class ClinicSettingsStep6 extends React.Component {
  constructor(props) {
    super(props);
  ...
  getUpdatedClinic (values) {
    const updatedClinic = {
      clinic: {
        ...
        diagnosysCenter: {
          id: this.state.clinic.diagnosysCenter.id,
          image: '',//this.state.clinic.diagnosysCenter.image,
          name: values.name,
  ...
  render() {
    return (
      <Formik
        initialValues={{
          name: this.state.clinic.diagnosysCenter.name,
          contactName: this.state.clinic.diagnosysCenter.contactName,
          email: this.state.clinic.diagnosysCenter.email,
          phone: this.state.clinic.diagnosysCenter.phone,
          fax: this.state.clinic.diagnosysCenter.fax,
          error: '',
          loader: false,
        }}
          ...
          return (
            <div>
              <div className="row">
                <CardBox
                  styleName="col-lg-12 "
                  heading={<IntlMessages id="dcInfo" />}
                  headerOutside
                >
