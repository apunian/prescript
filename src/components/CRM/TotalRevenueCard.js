...
const TotalRevenueCard = ({width}) => {
  return (
    <Widget title="Total Patients Growth" styleName="jr-card-metrics p-4">
      <div className="row no-gutters align-items-xl-end">
        <div className="col-xl-5 col-6 pr-2">
          <h3 className="mb-1 jr-fs-xxl jr-font-weight-bold">100</h3>
          <p className="mb-md-0 text-grey">YTD Growth</p>
        </div>
